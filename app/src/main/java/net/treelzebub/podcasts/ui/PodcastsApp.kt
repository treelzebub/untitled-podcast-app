...
fun PodcastsApp() {
    ...
    AppScaffold(
        ...
        topBar = { destination, backStackEntry -> PodcastsAppBar(navController, destination, backStackEntry) },
...
private fun PodcastsAppBar(
    ...
    Surface(shadowElevation = 4.dp) {
        TopAppBar(
            navigationIcon = {
                if (destination == PodcastDetailsScreenDestination) {
                    Icon(
                        modifier = Modifier
